...
replicating the movement of ants in a Y-maze experimental arena. Results to be published soon!

For a glimpse into some of my research, check out the poster below:

![A research poster presented at ICTP School in Nis (Serbia)](images\main_poster.png)

![A realisation of the unbounded hexagonal random walk](images\hex.png)